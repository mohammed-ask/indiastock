...
$todayopentradeid = $obj->selectfieldwhere(
    ...
    "stocktransaction.status = 0 and tradestatus='Open' and stocktransaction.type = 'Intraday' and date(stocktransaction.added_on) = date(CONVERT_TZ(NOW(),'+00:00','$timeskip')) and users.carryforward='No' and stockid != '' and stockid is not null  and exchange in ('N','B')  and exchtype = 'D'"
);
