...
<form class="row gy-2 gx-3 align-items-end" id="addfund">
    ...
    <button style="background-color: #4e4eff;" class="btn btn-success w-100 my-3" onclick="event.preventDefault();sendForm('', '', 'insertnominee', 'resultid', 'addfund')">Submit</button>
