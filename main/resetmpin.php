                    ...
                    <form onsubmit="event.preventDefault();sendForm('id', '<?= $id ?>', 'insertresetmpin', 'resultid', 'loginform');return 0;" id="loginform">
                        <div class="w-full">
                            ...
                            <label class="block text-sm" style="margin-bottom: 5px;position:relative">
                                ...
                                <input type="password" data-bvalidator="required,minlength[6],maxlenght[6]" id="password" name="mpin" class="block w-full  text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Give Strong Password!" />
