...
$return['recordsTotal'] = $obj->selectfieldwhere("users  ", "count(users.id)", "status in (0,1) and type = 2 ");
$return['recordsFiltered'] = $obj->selectfieldwhere("users ", "count(users.id)", "status in (0,1) and type = 2 $search ");
$return['draw'] = $_GET['draw'];
