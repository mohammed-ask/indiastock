...
<div class="page-body">
    <div class="card card-default">
        <div class=" flex" style="align-items: center;justify-content:space-between; padding: 0px 15px;
">
            ...
            <div class="card-tools">
                <?php if (in_array(46, $permissions)) { ?>
                    <a type="button" @click="openModal" onclick='dynamicmodal("none", "addstocklist", "", "Add New Stock")' class="my-6 px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        <b> + Add Stock List</b>
                    </a>
                <?php } ?>
            </div>
