...
$pendingfund = $obj->selectfieldwhere("fundrequest inner join users on users.id = fundrequest.userid", "count(id)", "fundrequest.status =0 $empref");
$todayaitraders = $obj->selectfieldwhere("aitraders inner join users on users.id = aitraders.userid", "count(id)", "aitraders.status =1 $empref");
?>
