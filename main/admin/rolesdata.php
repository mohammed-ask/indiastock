...
$return['recordsTotal'] = $obj->selectfieldwhere("roles  ", "count(roles.id)", "status=1 ");
$return['recordsFiltered'] = $obj->selectfieldwhere("roles ", "count(roles.id)", "status=1 $search ");
$return['draw'] = $_GET['draw'];
