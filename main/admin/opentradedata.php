...
while ($row = $obj->fetch_assoc($result)) {
    ...
    if (in_array(38, $permissions)) {
        $addaction = " <div style='display:none;flex-direction:row'><button class='flex items-center justify-between px-2 py-2  font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray' @click='openModal'  onclick='dynamicmodal(\"" . $row['id'] . "\", \"editstockprice\", \"\", \"Edit Stock Price\")'>
