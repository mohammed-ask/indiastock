...
$return['recordsTotal'] = $obj->selectfieldwhere("stocktransaction $join", "count(stocktransaction.id)", "stocktransaction.status in (1,0) $empref");
$return['recordsFiltered'] = $obj->selectfieldwhere("stocktransaction $join", "count(stocktransaction.id)", "stocktransaction.status in (1,0) $empref $search ");
$return['draw'] = $_GET['draw'];
$result = $obj->selectextrawhereupdate(
    ...
    "stocktransaction.status in (1,0) $empref $search $order limit $start, $limit"
);
