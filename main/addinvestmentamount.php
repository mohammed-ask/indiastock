...
<form id="adduser" onsubmit="event.preventDefault();sendForm('id', '<?= $id ?>', 'insertinvestmentamount', 'resultid', 'adduser');return 0;">
    <label class="block text-sm" style="margin-bottom: 5px;">
        ...
        <input name="amount" data-bvalidator="required,digit" step="any" class="block w-full  text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Amount" />
    </label>
    <label class="block text-sm" style="margin-bottom: 5px;">
