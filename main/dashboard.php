        ...
        <div class="col-lg-3">
            ...
            <div class="app-download-buttons d-app-none">
                <div class="card-body" style="padding:8px; padding-bottom: 25px; text-align:center;">
                    ...
                    <div class="row">
                        <div class="col-12 google-download-image mb-3"> <a target="_blank" href="https://play.google.com/store/apps/details?id=com.pmsvistacapital"> <img style="border-radius:4px;" width="100%" src="main/dist/userimages/Play-Store.png" alt="Download from Play Store"></a></div>
